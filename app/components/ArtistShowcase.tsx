...
const artists = [
  { top: "RAHAT", bottom: "FATEH ALI", tour: "The Legacy Tour", loc: "Quayside Arena, Sydney", img: "https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?auto=format&fit=crop&q=80&w=1600" },
  { top: "ARIJIT", bottom: "SINGH", tour: "Symphony of Soul", loc: "O2 Arena, London", img: "https://images.unsplash.com/photo-1493225255756-d9584f8606e9?auto=format&fit=crop&q=80&w=1600" },
  { top: "KUMAR", bottom: "SANU", tour: "90s King Live", loc: "Madison Square, NY", img: "https://images.unsplash.com/photo-1525926477800-7a3b40add5a5?auto=format&fit=crop&q=80&w=1600" },
  { top: "KAPIL", bottom: "SHARMA", tour: "Comedy Gold", loc: "The Forum, LA", img: "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?auto=format&fit=crop&q=80&w=1600" },
  { top: "SALMAN", bottom: "KHAN", tour: "Da-Bangg Tour", loc: "Dubai Parks, DXB", img: "https://images.unsplash.com/photo-1470225620780-dba8ba36b745?auto=format&fit=crop&q=80&w=1600" },
  { top: "ASHA", bottom: "BHOSLE", tour: "Eternal Voice", loc: "Esplanade, Singapore", img: "https://images.unsplash.com/photo-1514525253361-bee8a19740c1?auto=format&fit=crop&q=80&w=1600" }
];
  ...
  return (
    <div className="min-h-screen w-full flex flex-col items-center justify-between py-6 md:py-10 bg-[#080808] text-white relative overflow-x-hidden md:overflow-hidden select-none">
      ...
      <div ref={contentRef} className="relative z-10 text-center px-4 flex-grow flex flex-col justify-center w-full max-w-7xl py-10 md:py-0">
        ...
        <p id="a-tour" className="marcellus text-lg md:text-3xl mt-4 md:mt-6 text-[#D4AF37] italic">
